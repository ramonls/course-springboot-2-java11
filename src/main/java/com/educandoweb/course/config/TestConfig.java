...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Salvando novamente para as associações acima, com as categorias (particularidade JPA)
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		
		User u1 = new User(null, "Maria Brown", "maria@gmail.com", "1234569872", "123456");
		User u2 = new User(null, "Alex Green", "alex@gmail.com", "1594873261", "147852");
